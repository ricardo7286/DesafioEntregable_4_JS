...
//FIN FUNCION MOSTRAR PACIENTES
  ...
  swal.fire({
      title: 'Bienvenido',
      text: 'Herramienta de evaluación de la Escala de Coma de Glasgow (en Inglés Glasgow Coma Scale (GCS))',
      icon: 'info',
